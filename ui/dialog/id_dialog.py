...
"}")
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"Single object track", None))
        self.label.setText(QCoreApplication.translate("Form", u"Please input car ID:", None))
        self.idEdit.setText("")
