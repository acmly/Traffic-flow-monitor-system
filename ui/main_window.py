...
"}")
        ...
        self.progress_bar.setFormat("Current Progress:%p%")
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"by Fan", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"TFMS", None))

        self.ToggleBotton.setText(QCoreApplication.translate("MainWindow", u"Hide", None))

        self.src_file_button.setText(QCoreApplication.translate("MainWindow", u"Local Files", None))
        ...
        self.src_graph_button.setText(QCoreApplication.translate("MainWindow", u"  Volume Flow", None))
        self.src_lock_button.setText(QCoreApplication.translate("MainWindow", u"  Single Object Track", None))
        self.src_web_button.setText(QCoreApplication.translate("MainWindow", u"  Website", None))


        self.VersionLabel.setText(QCoreApplication.translate("MainWindow", u"Version: 1.0", None))

        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"YOLOv8-based Traffic Flow Monitor System", None))
        ...
        self.char_label.setText(QCoreApplication.translate("MainWindow", u"Current cars: 0", None))

        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Total class", None))
        self.Class_num.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Total number", None))
        self.Target_num.setText("")
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"fps", None))
        self.fps_label.setText("")
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Model used", None))
        ...
        self.ToggleBotton_5.setText(QCoreApplication.translate("MainWindow", u"Alarm Threshold", None))


        # TFMS (Traffic Flow Monitor System)
        self.status_bar.setText(QCoreApplication.translate("MainWindow", u"Welcome", None))
        # self.status_bar.setText(QCoreApplication.translate("MainWindow", u"Welcome to Traffic Flow Monitor System", None))

        self.show_labels_checkbox.setText(QCoreApplication.translate("MainWindow", u"Show Label", None))
        self.show_trace_checkbox.setText(QCoreApplication.translate("MainWindow", u"Show Track", None))

        self.save_res_button.setText(QCoreApplication.translate("MainWindow", u"Save to MP4/JPG", None))
        self.save_txt_button.setText(QCoreApplication.translate("MainWindow", u"Save to label(.txt)", None))
